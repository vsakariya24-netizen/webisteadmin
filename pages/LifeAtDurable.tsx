...
const LifeAtDurable: React.FC = () => {
  ...
  return (
    <div ref={targetRef} className="bg-slate-50 min-h-screen font-sans selection:bg-purple-500 selection:text-white overflow-x-hidden">
      ...
      {/* =================================================================
         1. HERO SECTION — “Where People Come First.”
      ================================================================= */}
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="md:col-span-2 rounded-[2.5rem] bg-gradient-to-br from-blue-600 to-indigo-700 text-white p-10 flex flex-col justify-between relative overflow-hidden group">
             ...
             <div>
                <h3 className="text-3xl font-bold mb-4">People-First Mindset</h3>
                <p className="text-blue-100 text-lg max-w-md">We value mental wellness and genuine connections over metrics. You are a person here, not a resource.</p>
             </div>
          </motion.div>
          ...
          <motion.div variants={fadeInUp} className="md:col-span-2 rounded-[2.5rem] bg-slate-900 text-white p-10 flex items-center justify-between relative overflow-hidden">
             <div className="relative z-10">
                <h3 className="text-2xl font-bold mb-2">Transparent Leadership</h3>
                <p className="text-slate-400">Open doors. Open conversations. Learning over blaming.</p>
             </div>
      ...
      {/* =================================================================
         4. STAFF ACTIVITIES (Fun at Work)
      ================================================================= */}
      <section className="py-24 bg-slate-50 overflow-hidden">
        ...
        <div className="flex gap-6 overflow-x-auto pb-12 px-6 snap-x hide-scrollbar max-w-[100vw]">
          {[
            { title: "Diwali Bash", img: "https://images.unsplash.com/photo-1514525253440-b393452e2729?w=800", tag: "Festival" },
            { title: "Goa Retreat", img: "https://images.unsplash.com/photo-1523580494863-6f3031224c94?w=800", tag: "Trip" },
            { title: "Box Cricket", img: "https://images.unsplash.com/photo-1593341646782-e0b495cffd32?w=800", tag: "Sports" },
            { title: "Awards Night", img: "https://images.unsplash.com/photo-1511632765486-a01980e01a18?w=800", tag: "Recognition" },
            { title: "Fun Fridays", img: "https://images.unsplash.com/photo-1528605248644-14dd04022da1?w=800", tag: "Culture" },
          ].map((item, i) => (
             <motion.div 
               key={i}
             ...
             >
                ...
                <div className="absolute bottom-8 left-8 text-white">
                   <span className="text-xs font-bold bg-white/20 backdrop-blur px-3 py-1 rounded-full uppercase mb-2 inline-block">{item.tag}</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
               ...
               <div className="bg-white p-10 rounded-3xl shadow-sm border border-slate-100">
                  ...
                  <div className="grid grid-cols-1 gap-6">
                     {[
                        "Professional Growth & Skill Building",
                        ...
                        <div key={i} className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50">
                           ...
                           <span className="font-medium text-lg text-slate-700">{item}</span>
                        </div>
                     ))}
                  </div>
               </div>
               ...
               <div className="bg-slate-900 text-white p-10 rounded-3xl shadow-xl">
                  ...
                  <div className="space-y-6">
                     <div className="flex gap-4">
                        ...
                        <div>
                           <h4 className="font-bold text-lg">Respect is Default</h4>
                           <p className="text-slate-400 text-sm">No shouting. No blaming. Discipline with kindness.</p>
                        </div>
                     </div>
                     <div className="flex gap-4">
                        <CheckCircle className="text-green-400 shrink-0 mt-1" />
                        <div>
                           <h4 className="font-bold text-lg">Zero Politics Policy</h4>
                           <p className="text-slate-400 text-sm">We don't tolerate toxicity. Mutual trust at every level.</p>
                        </div>
                     </div>
                     <div className="flex gap-4">
                        <CheckCircle className="text-green-400 shrink-0 mt-1" />
                        <div>
                           <h4 className="font-bold text-lg">Calm & Professional</h4>
                           <p className="text-slate-400 text-sm">A supportive environment where you can focus.</p>
                        </div>
                     </div>
                  </div>
               </div>
      ...
      <section className="py-24 px-6 bg-white relative">
         <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
               {[
                  { name: "Rahul M.", role: "Production Lead", quote: "I joined as a trainee. In 3 years, I'm leading a team of 40. Durable saw potential in me I didn't see in myself." },
                  { name: "Sneha P.", role: "Sales Executive", quote: "The culture here is different. You aren't just an employee number. My ideas actually get implemented." }
               ].map((story, i) => (
                  <motion.div 
                     key={i}
                     whileHover={{ y: -5 }}
      ...
      <section className="py-24 bg-black text-white px-6 overflow-hidden">
         <div className="max-w-7xl mx-auto text-center">
            <h2 className="text-5xl md:text-8xl font-black mb-12">
               BUILT FOR <span className="text-transparent bg-clip-text bg-gradient-to-r from-lime-400 to-green-500">GEN-Z</span>
            </h2>
            <p className="text-xl text-slate-400 max-w-2xl mx-auto mb-12">
               We understand this generation. We give respect, we build growth, and we offer purpose.
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-4 max-w-5xl mx-auto">
               {[
                  ...
                  <motion.div 
                     ...
                     className="px-6 py-3 rounded-full border border-white/20 text-lg font-bold bg-white/5 hover:bg-lime-400 hover:text-black hover:border-lime-400 transition-all cursor-default select-none"
                  >
                     {tag}
                  </motion.div>
               ))}
      ...
      {/* =================================================================
         11 & 12. CAREER GROWTH & PROMISE
      ================================================================= */}
      <section className="py-24 px-6 bg-slate-50">
         <div className="max-w-5xl mx-auto">
            <SectionHeader title="Your Journey. Our Mission." subtitle="We don't wait for talent to shine — we help it shine faster." />
            
            <div className="space-y-4">
               {[
                  { title: "Structured Growth Planning", desc: "We map your year before it starts." },
                  { title: "Transparent Promotions", desc: "No guessing games. Hit the target, get the role." },
                  { title: "Leadership Opportunities", desc: "Prove your worth and lead the pack." }
               ].map((item, i) => (
                  <motion.div 
                     key={i}
                     ...
                     className="bg-white p-6 rounded-2xl border border-slate-200 flex items-center gap-6 shadow-sm hover:shadow-md transition-shadow"
                  >
                     <div className="w-12 h-12 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center font-bold text-xl">{i + 1}</div>
                     <div>
            ...
            <div className="mt-20 bg-blue-600 rounded-3xl p-10 text-center text-white relative overflow-hidden">
               <div className="relative z-10">
                  ...
                  <p className="text-xl text-blue-100 max-w-2xl mx-auto">
                     Join a company that feels like the future. We don't hire people to fill seats — we hire people to build a legacy.
                  </p>
               </div>
      ...
      <section className="py-32 relative overflow-hidden bg-white">
        <div className="container mx-auto px-6 text-center relative z-10">
           ...
           <motion.button 
             ...
             whileTap={{ scale: 0.95 }}
             className="bg-slate-900 text-white px-12 py-6 rounded-full text-xl font-bold hover:shadow-[0_20px_50px_rgba(0,0,0,0.3)] transition-all duration-300 flex items-center gap-3 mx-auto"
           >
              Apply Now <Rocket />
           </motion.button>
        </div>
